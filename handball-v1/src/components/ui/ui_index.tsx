...
export const Button = forwardRef<HTMLButtonElement, BtnProps>(
  ({ variant='primary', size='md', loading, icon, className, children, disabled, type='button', ...p }, ref) => (
    <button
      ref={ref}
      type={type}
...
export function Toast({ message, type='success', onClose, duration=3500 }: {
  ...
  return (
    <div className={clsx(
      ...
      <button type="button" onClick={onClose} className="ml-1 hover:opacity-70"><X size={15}/></button>
    </div>
  )
}
