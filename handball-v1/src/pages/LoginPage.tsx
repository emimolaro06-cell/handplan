    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-white/15 border-2 border-white/25 mb-4">
            <img src={logoUrl} alt={accountName} className="w-16 h-16 object-contain"/>
          </div>
